...
class ViewController: UIViewController {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "toLoginSuccess" {
            let destVC = segue.destination as! FavoriteViewController
            destVC.prefix = loginPrefix.text
        }
    }
    ...
    @IBAction func loginPressed() {
        ...
        let urlString: String = "http://condi.swu.ac.kr/student/\(loginPrefix.text!)/login/loginUser.php" //링크 확인하기
